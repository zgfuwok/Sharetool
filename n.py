...
\033[1;36;40m*Cre: Dươngg Phú Quốcc\033[1;32m☑
\033[1;36;40m*Liên hệ support: fb.com/100042415576964
\033[1;36;40m*Mọi thắc mắc về tool liên hệ Quốcc giải quyết!!
...
def run(sdt,i):
  ...
  print(" ~ » </> » SUCCESS SPAM | NUMBER TIME: ",i)
  for j in range(0,6):
